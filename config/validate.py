...
REQUIRED_OPENAI_KEYS = [
    ...
    "relevance_threshold", "scoring_model", "validator_model",
...
def assert_openai_settings(cfg):
    ...
    print(f"✅ Config validation passed - all {len(REQUIRED_OPENAI_KEYS)} required keys present")
...
def validate_config_complete():
    ...
    try:
        ...
        critical_attrs = ['ENV', 'PODCAST_BASE_URL', 'AUDIO_BASE_URL', 'TRANSCRIPTS_DIR']
