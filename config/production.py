...
class ProductionConfig:
    ...
    def __post_init__(self):
        ...
        self.OPENAI_SETTINGS = {
            ...
            ),  # Cost-effective for scoring
            "validator_model": _env(
    ...
    # ---------- GUID / Stability ----------
    def stable_guid_for_digest(
        self, topic: str, date: datetime, episode_ids: Optional[List[str]]
    ) -> str:
        """
    ...
    def validate_quota_usage(
        self, tokens_used: int, requests_made: int
    ) -> Dict[str, Any]:
