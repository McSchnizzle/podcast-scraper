...
from utils.datetime_utils import (
    now_utc, to_utc, cutoff_utc, ensure_aware_utc,
    parse_struct_time_to_utc, parse_entry_to_utc, parse_rss_datetime
)
...
class TestRSSParsing:
    ...
    def test_parse_struct_time_to_utc_valid(self):
        ...
        time_struct = (2025, 1, 15, 12, 30, 45, 2, 15, 0)  # (year, month, day, hour, min, sec, wday, yday, dst)
