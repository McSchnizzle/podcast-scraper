...
from utils.redact import redact_dict, redact_secrets
...
class TestSecretRedaction(unittest.TestCase):
    ...
    def test_redact_dict(self):
        ...
        data_with_secrets = {
            ...
            "nested": {"token": "abc123def456", "normal": "value"},
        }
    ...
    def test_generate_digest_mock_mode(self):
        ...
        try:
            ...
            digester = OpenAIDigestIntegration(
                rss_db_path=self.db_path, youtube_db_path=self.db_path
            )
...
class TestEndToEndIntegration(unittest.TestCase):
    ...
    def test_full_pipeline_mock_mode(self):
        ...
        test_transcript.write_text(
            "This is a comprehensive test transcript about artificial intelligence and machine learning technologies."
        )
        ...
        try:
            ...
            validator = ProseValidator()
            success, validated_text, issues = validator.ensure_prose_quality(
                digest_result.get("content", "")
            )
            self.assertTrue(success)
