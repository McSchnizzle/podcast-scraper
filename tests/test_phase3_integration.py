            ...
            if "METRIC" in log_output:
                ...
                if metric_lines:
                    ...
                    try:
                        ...
                        print("⚠️ Metrics logged but not in JSON format (acceptable for Phase 3)")
                        return True
                else:
...
def test_conditional_export():
    ...
    try:
        ...
        if 'OpenAIScorer' in all_exports_with_alias:
            ...
            print("⚠️ Legacy alias not exported even with env var (check implementation)")
...
def test_episode_failures_integration():
    ...
    try:
        ...
        print("✅ Episode failures integration works - can import and instantiate scorer")
        return True
    except ImportError as e:
