...
def setup_static_music_library():
    ...
    if music_cache.exists():
        ...
        segment_files = list(music_cache.glob("*_intro.mp3")) + list(music_cache.glob("*_background.mp3")) + list(music_cache.glob("*_outro.mp3"))
    ...
    logger.info("🚀 Future TTS generations will use these cached music files automatically.")
