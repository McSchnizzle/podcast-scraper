...
def safe_path_join(*components) -> Path:
    ...
    for component in components[1:]:
        ...
        if '..' in component_str or component_str.startswith('/') or ':' in component_str:
            raise ValueError(f"Potential path traversal detected in component: {component_str}")
...
def validate_file_path(file_path: Union[str, Path], allowed_dirs: Optional[list] = None) -> bool:
    """
